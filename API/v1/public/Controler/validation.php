<?php
    ...
    /**
     * @param _array the array that will be processed to safety
     * @return _array either false or a correct array
     */
     ...
     * @param username 
     * @param password_hash 
     * @param id The SQL record Id
     * @return token the hash of username password and secret Seperated with the Id by "[tr]" 
     */
